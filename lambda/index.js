...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bem-vindo, você ouvirá Rádio Unifisa Oficial!';
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt(speakOutput)
            .addAudioPlayerPlayDirective('REPLACE_ALL', 'https://servidor25.brlogic.com:7130/live', 1, 0, null, null)
            .getResponse();
    }
};
/**
 ...
 * */
const UnifisaIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && (Alexa.getIntentName(handlerInput.requestEnvelope) === 'UnifisaIntent'
                || Alexa.getIntentName(handlerInput.requestEnvelope) === 'AMAZON.ResumeIntent');
    },
    async handle(handlerInput) {
        const playbackInfo = await getPlaybackInfo(handlerInput);
        const speakOutput = 'Reproduzindo a Rádio Unifisa Oficial.';
        const playBehavior = 'REPLACE_ALL';
        const podcastUrl = 'https://servidor25.brlogic.com:7130/live';
...
const UnsupportedAudioIntentHandler = {
    ...
    async handle(handlerInput) {
        const speakOutput = 'Desculpe, ainda não posso suportar isso.';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Você pode dizer "reproduzir áudio" para começar a tocar música! Como posso ajudar?';
...
const CancelarIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Obrigado por Ouvir a Rádio Unifisa Oficial!';
